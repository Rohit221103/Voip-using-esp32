...
//IPAddress receiverIP(192, 168, 55, 226); // IP address of the receiver ESP32
IPAddress receiverIP(192, 168, 55, 7);
...
#define bufferLen 64 //64
#define bufferCnt 8 //64 //8
